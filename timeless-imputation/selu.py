...
# (2) use SELUs
@add_variable_scope(name="selu_nlin")
def nlin(x):
...
# (4) use this dropout
def dropout(x, keep_prob, alpha= -1.7580993408473766, fixedPointMean=0.0, fixedPointVar=1.0,
            noise_shape=None, seed=None, name=None, training=False):
    """Dropout to a value with rescaling."""

    def dropout_selu_impl(x, keep_prob, alpha, noise_shape, seed, name):
